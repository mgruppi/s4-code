...
def main():
    ...
    parser.add_argument("--normalized", action="store_true", help="Force word vectors to have norm 1")
    parser.add_argument("--r-range", dest="r_range", default=1, type=float, help="Max value of r")
    parser.add_argument("--r-steps", dest="r_step", default=2, type=int, help="No. of times in which r is increased")
    parser.add_argument("--r", type=float, default=0.25, help="Value of the rate")
